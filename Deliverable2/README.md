...
* Προσθήκη **συστήματος ζωών**. Ο παίκτης ξεκινάει με 3 ζωές και χάνει μία αν έρθει σε επαφή με εχθρό. Αν χάσει όλες του τις ζωές, εμφανίζεται ανάλογη οθόνη και γίνεται αναπαραγωγή ηχητικού εφέ και επιστροφή στο αρχικό menu.
