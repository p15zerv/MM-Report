...
* Προσθήκη νέων tile στο αρχικό tileset:
  ...
  - <img src="https://user-images.githubusercontent.com/22644005/35172033-c1c9a61e-fd6e-11e7-86c0-59aa561c6d3c.png" alt="" width="30" height="30"> Αναπαριστά τα σημεία τοποθέτησης του παίκτη.
  ...
  - <img src="https://user-images.githubusercontent.com/22644005/35171551-db522388-fd6c-11e7-9805-eaa03d4d1428.PNG" alt="" width="30" height="30"> Αναπαριστά τα σημεία τοποθέτησης των πετρών (παραδοτέο 3.
  - <img src="https://user-images.githubusercontent.com/22644005/35171551-db522388-fd6c-11e7-9805-eaa03d4d1428.PNG" alt="" width="30" height="30"> Αναπαριστά τα σημεία τοποθέτησης των λουλουδιών.
  
  Όλα εκτός του πρώτου υλοποιήθηκαν για το 4ο παραδοτέο αλλά τοποθετήθηκαν εδώ για να βρίσκονται σε ένα σημείο όλες οι αλλαγές στο αρχικό tileset. 
  
  Όλα τα παραπάνω tiles αντικαθίστανται από το αντίστοιχο αντικείμενο μόλις εντοπιστούν.
